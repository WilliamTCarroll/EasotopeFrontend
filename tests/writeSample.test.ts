...
describe("Writing Sample and Replicate to Xlsx", () => {
    ...
    it("Generate Full Sample", () => {
        ...
        const exp = [
            [, "DH1D"],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            ["stdErr", , , , , , , , , , { t: "n", f: "STDEV(K1:K3)/SQRT(COUNT(K1:K3))" }, , , , { t: "n", f: "STDEV(O1:O3)/SQRT(COUNT(O1:O3))" }],
            ["average", , , , , , , , , , , , { t: "n", f: "AVERAGE(M1:M3)" }],
            ["stdDev", , , , , , , , , , , , { t: "n", f: "STDEV(M1:M3)" }],
            ["Disabled Replicates Below"],
            [, "R2", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94]
        ];
        assert.deepStrictEqual(out, exp);
    })
    it("Generate Group of Samples", () => {
        ...
        s3["Replicate"] = "DH3D";
        const exp = [
            ["Notes/Issues", "Replicate", "Run Date", "Analysis", "Analysis Status", "Mass Spec", "Easotope Name", "Sample Type", "Corr Interval", "Acid Temp", "d13C VPDB (Raw)", "d13C VPDB (Raw) SE", "δ13C VPDB (Final)", "SomethingElse", "d18O VPDB (Raw)"],
            [],
            [, "DH1D"],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            ["stdErr", , , , , , , , , , { t: "n", f: "STDEV(K4:K6)/SQRT(COUNT(K4:K6))" }, , , , { t: "n", f: "STDEV(O4:O6)/SQRT(COUNT(O4:O6))" }],
            ...
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            ["stdErr", , , , , , , , , , { t: "n", f: "STDEV(K14:K15)/SQRT(COUNT(K14:K15))" }, , , , { t: "n", f: "STDEV(O14:O15)/SQRT(COUNT(O14:O15))" }],
            ["average", , , , , , , , , , , , { t: "n", f: "AVERAGE(M14:M15)" }],
            ...
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            [, "R1", "2018-03-05 02:31 PST", "CO2 clumpD48", "OK", "R2D2 - NuCarb", "DH1A", "Calcite", "2018-02-17 00:00:00 PST", 70, -0.84, , -0.86, , 8.94],
            ["stdErr", , , , , , , , , , { t: "n", f: "STDEV(K23:K24)/SQRT(COUNT(K23:K24))" }, , , , { t: "n", f: "STDEV(O23:O24)/SQRT(COUNT(O23:O24))" }],
            ["average", , , , , , , , , , , , { t: "n", f: "AVERAGE(M23:M24)" }],
